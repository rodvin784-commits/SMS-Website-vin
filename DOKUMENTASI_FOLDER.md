...
- **2026-09-24 lanjut DRY & pagination full:** `hooks/useDebouncedValue.ts:1` + `KelasManager.tsx:133`/`JurusanManager.tsx:76`/`MataPelajaranManager.tsx:246` pagination 20 + debounce + `totalPages`; `hooks/useAdminMutate.ts:1` dipakai `JurusanManager:92`/`KelasManager:155`/`MataPelajaranManager:293`/`JadwalManager:149` (CRUD 60→12 baris); `lib/user-validation.ts:1` `validateUserCreate/Edit` dipakai `CreateUserModal:46`/`EditUserModal:70`/`app/admin/users/page.tsx:126` (DRY validasi email/password/NIS/kelas); `hooks/useTeacherAuth.ts:1` DRY 7 guru pages.
